    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'all') {
            ...
            let embed = new MessageEmbed()
              .setColor("GREEN")
              .setDescription(`<a:wrong:908686422184198184> **You Do Not Have Any Money To Withdraw!**`)
            ...
            let embed2 = new MessageEmbed() 
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> Specify an amount to withdraw!`);
            ...
            let embed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184> You can't withdraw negative money!`);
            ...
            let embed4 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:wrong:908686422184198184>You don't have that much money in the bank!`);
