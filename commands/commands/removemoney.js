...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.member.hasPermission("ADMINISTRATOR", "MANAGE_GUILD")) return message.channel.send("<a:wrong:908686422184198184> You do not have permissions to remove money!");
        ...
        let moneyEmbed = new MessageEmbed()
            .setColor("GREEN")
            .setDescription(`<a:money:908685366184271923> Removed ${args[1]} coins\n\nNew Balance: ${bal2}`);
