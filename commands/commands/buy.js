    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'bronze') {
            ...
            let Embed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:money:908685366184271923> Purchased Bronze VIP For 200 Coins`);
            ...
            let Embed4 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:money:908685366184271923> Purchased Fresh Nikes For 600 Coins`);
            ...
            let Embed6 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:money:908685366184271923> Purchased A New Car For 800 Coins`);
            ...
            let Embed8 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:money:908685366184271923> Purchased A Mansion For 1200 Coins`);
            ...
            let Embed4 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:money:908685366184271923> I already added your custom role, ask an admin to give you the role`);
